...
namespace hsai
{
	...
	extern void ( *p_hsai_logout )( HsaiLogLevel log_level, const char *fn, uint ln,
									const char *info, ... );
...
#define hsai_trace( trace_info, args... )                                                        \
	do {                                                                                         \
		( hsai::p_hsai_logout )                                                                  \
			? ( hsai::p_hsai_logout( hsai::log_trace, __FILE__, __LINE__, trace_info, ##args ) ) \
			: ( (void) 0 );                                                                      \
	}                                                                                            \
	while ( 0 )
...
#define hsai_info( info__info, args... )                                                        \
	do {                                                                                        \
		( hsai::p_hsai_logout )                                                                 \
			? ( hsai::p_hsai_logout( hsai::log_info, __FILE__, __LINE__, info__info, ##args ) ) \
			: ( (void) 0 );                                                                     \
	}                                                                                           \
	while ( 0 )
...
#define hsai_warn( warn__info, args... )                                                        \
	do {                                                                                        \
		( hsai::p_hsai_logout )                                                                 \
			? ( hsai::p_hsai_logout( hsai::log_warn, __FILE__, __LINE__, warn__info, ##args ) ) \
			: ( (void) 0 );                                                                     \
	}                                                                                           \
	while ( 0 )
...
#define hsai_error( error_info, args... )                                                        \
	do {                                                                                         \
		( hsai::p_hsai_logout )                                                                  \
			? ( hsai::p_hsai_logout( hsai::log_error, __FILE__, __LINE__, error_info, ##args ) ) \
			: ( (void) 0 );                                                                      \
	}                                                                                            \
	while ( 0 )
...
#define hsai_panic( panic_info, args... )                                                        \
	do {                                                                                         \
		( hsai::p_hsai_logout )                                                                  \
			? ( hsai::p_hsai_logout( hsai::log_panic, __FILE__, __LINE__, panic_info, ##args ) ) \
			: ( (void) 0 );                                                                      \
		while ( 1 );                                                                             \
	}                                                                                            \
	while ( 0 )
...
#	define RED_COLOR_PINRT		"\033[31;1m"
