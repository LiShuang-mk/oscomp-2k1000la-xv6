...
namespace loongarch
{
	namespace qemu2k1000
	{
		...
		void Memory::memory_init()
		{
			...
			cpu->write_csr( csr::pwch,
							( hsai::pgd_mask_shift << csr::pwch_dir3_base_s ) |
								( hsai::page_number_mask_width << csr::pwch_dir3_width_s ) |
								( 0 << csr::pwch_dir4_base_s ) | ( 0 << csr::pwch_dir4_width_s ) );

			// config IO DMA accessing memory window

			// *(volatile uint64*) loongarch::qemu2k1000::XbarWin::xwin4_base1 =
			// 	// loongarch::qemu2k1000::iodma_win_base;
			// 	0x0;
			// *(volatile uint64*) loongarch::qemu2k1000::XbarWin::xwin4_mask1 =
			// 	// loongarch::qemu2k1000::iodma_win_mask;
			// 	0xFFFF'FFFF'0000'0000UL;
			// *(volatile uint64*) loongarch::qemu2k1000::XbarWin::xwin4_mmap1 =
			...
			// 	0x0000'0000 |
			// 	// ( loongarch::qemu2k1000::sec_win_route_ddr
			// 	//   << loongarch::qemu2k1000::sec_win_rt_s ) |
			// 	// ( loongarch::qemu2k1000::sec_win_br_m ) | ( loongarch::qemu2k1000::sec_win_en_m
			// 	// );
			// 	// 0xF0;
			// 	0x0;

			// test secondary exchange window -- CPU window

			// *(volatile u64*) loongarch::qemu2k1000::SecondWin::cpu_win2_base = 0x0;
			// *(volatile u64*) loongarch::qemu2k1000::SecondWin::cpu_win2_mask = 0xFFFF'FFFF'0000'0000UL;
			// *(volatile u64*) loongarch::qemu2k1000::SecondWin::cpu_win2_mmap = 0x0;
		}
		...
		ulong Memory::to_vir( ulong addr ) { return to_phy( addr ) | dmwin::win_0; }

		ulong Memory::to_phy( ulong addr ) { return addr & ~dmwin_mask; }

		ulong Memory::to_io( ulong addr ) { return to_phy( addr ) | dmwin::win_1; }

		ulong Memory::to_dma( ulong addr ) { return to_phy( addr ) | iodma_win_base; }
